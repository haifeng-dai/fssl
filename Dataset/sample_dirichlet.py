...
def build_non_iid_by_dirichlet(
    ...
    for _targets in splitted_targets:
        ...
        _idx_batch = None
        while (
            min_size < int(0.50 * _targets_size / _n_workers)
        ):  # the data number for each client cannot be smaller than 0.5 * average, otherwise re-build
            ...
            for _class in range(num_classes):
                ...
                try:
                    ...
                    # balance, in order to guarantee that the data number for current client is not greater than average.
...
def clients_indices_unlabel(
    ...
    batch_indices = build_non_iid_by_dirichlet_unlabel(
        seed=seed,
        indices2targets=indices2targets,
        non_iid_alpha=non_iid_alpha,
        num_classes=num_classes,
...
def clients_indices_unlabel1(
    ...
    batch_indices = build_non_iid_by_dirichlet_unlabel1(
        seed=seed,
        indices2targets=indices2targets,
        non_iid_alpha=non_iid_alpha,
        num_classes=num_classes,
